...
public class NewRedCrownedCraneCameraScript : MonoBehaviour {
	public GameObject target;
	public GameObject redCrownedCraneCamera;
	...
	void Update(){
		...
		redCrownedCraneCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
