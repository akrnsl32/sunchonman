...
public class BowerBirdRootMotionFlyUserController : MonoBehaviour {
	BowerBirdRootMotionFlyCharacter bowerBirdCharacter;
	public float upDownInputSpeed=1f;
	
	void Start () {
		bowerBirdCharacter = GetComponent <BowerBirdRootMotionFlyCharacter> ();
	}
